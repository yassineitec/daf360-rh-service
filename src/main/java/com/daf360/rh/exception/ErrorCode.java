...
public enum ErrorCode {
    ...
    OFFER_NOT_FOUND                 (HttpStatus.NOT_FOUND,                "Offre introuvable pour ce candidat"),
    OFFER_ALREADY_EXISTS            (HttpStatus.CONFLICT,                 "Une offre existe déjà pour ce candidat"),
    OFFER_STATUS_INVALID            (HttpStatus.UNPROCESSABLE_CONTENT,    "Action impossible : statut de l'offre incompatible"),
    OFFER_INTERVIEW_REQUIRED        (HttpStatus.UNPROCESSABLE_CONTENT,    "Une offre nécessite au moins un entretien validé (réussi) et aucun échec"),
